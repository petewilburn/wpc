...
export function BlogCard({ post }: { post: BlogPost }) {
  return (
    <Card className="bg-white border-border shadow-sm group hover:shadow-md transition-all flex flex-col h-full overflow-hidden">
      <CardContent className="p-6 flex flex-col flex-1">
        ...
        <div className="mt-auto pt-4 border-t border-border flex items-center justify-between">
          <span className="text-sm font-medium text-foreground">{post.author || "Wilburn Pacific"}</span>
